...
@section('content')
    <main id="main">
        ...
        <div class="formbold-main-wrapper">
            ...
            <div class="container">
                Klik untuk melihat =><a href="{{ route('kriteria.kriUser') }}">Skor User</a><br><br>
                <div class="card">
                    <div class="card-body">
            ...
            <div class="container">
                Klik untuk melihat =><a href="{{ route('kriteria.kriSoal') }}">Skor Essay</a><br><br>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
