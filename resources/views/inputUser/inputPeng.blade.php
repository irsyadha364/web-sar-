    ...
    <main id="main">
        ...
        <div class="formbold-main-wrapper">
            ...
            <div class="formbold-form-wrapper">
                    ...
                    <svg width="490" height="215" viewBox="0 0 490 215" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <defs>
                            ...
                            <div class="formbold-event-details">
                                <h5>Form Laporan Giat Anggota</h5>
                                <ul>
                                    <p>
                                        Isi form berdasarkan Keikutsertaan Anggota Rescue 020 dalam suatu kegiatan yang
                ...
                <form action="{{ route('inputPeng.store') }}" method="POST">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="dataPendukung" id="story" rows="5" cols="33" class="formbold-form-input"></textarea>
                    </div><br>
