    ...
    <main id="main">
        ...
        <div class="formbold-main-wrapper">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                {{-- <a href="{{ route('aspek.inputAspek') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data
                </a> --}}
            </div>
            <div class="container">
                <div class="card">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr style="text-align: center">
                                        <th scope="col">{{ __('Aspek Nilai') }}</th>
                                ...
                                <tbody>
                                    ...
                                    {{-- @foreach ($aspek as $aspek)
                                        <tr style="text-align: center">
                                            <td>{{ $aspek->aspekNilai }}</td>
                                            <td>{{ $aspek->bobotCore }}</td>
                                            <td>{{ $aspek->bobotSecondary }}</td>
                                            <td>
                                                <div class="btn-group" role="group" aria-label="{{ __('User') }}">
                                                    ...
                                                    <form action="{{ route('aspek.destroy', $aspek->id) }}"
                                                        method="POST"
